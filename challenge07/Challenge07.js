...
const objLat = (obj) => {
    let answer ;
    let name1 =obj.firstName.charAt(0).toUpperCase() + obj.firstName.slice(1) ;
    let name2 =obj.lastName.charAt(0).toUpperCase() + obj.lastName.slice(1) ;

    answer=`my name is ${name1} ${name2} I am ${obj.age} YO, and I love ${obj.hobby}.` ;
    return answer ;
};
// -------------------------------------------------------------------------------------------------------
...
const cvFormatter = (arr) => {
    ...
    obj['fullName']="";
    obj['tech']="";
    let arr2=arr.forEach(elemnt=>{
        if (elemnt.yearsOfExperience>1){
        // obj['fullName'] =fullName(elemnt.firstName,elemnt.LastName)
        // obj['tech']=elemnt.tech;
        newArr.push({fullName: fullName(elemnt.firstName,elemnt.lastName),tech:elemnt.tech});
  }
